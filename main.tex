...
\subfile{./txt/2-projektmanagement.tex}
\subfile{./txt/3-literature.tex}
\subfile{./txt/4-daten.tex}
\subfile{./txt/5-methoden.tex}
\subfile{./txt/6-ergebnisse.tex}
\subfile{./txt/7-diskussion.tex}
