...
\ifthenelse{\boolean{\mywip}}{}{
    ...
    \begin{titlepage}
        ...
        \begin{tabularx}{\textwidth}{XX}
            \centering \myAuthorIV  & \centering \arraybackslash \myAuthorII \\
            \centering \myNumberIV  & \centering \arraybackslash \myNumberII \\
            \centering \myEmailIV   & \centering \arraybackslash \myEmailII  \\[1.5em]
            \centering \myAuthorIII & \centering \arraybackslash \myAuthor   \\
            \centering \myNumberIII & \centering \arraybackslash \myNumber   \\
            \centering \myEmailIII  & \centering \arraybackslash \myEmail
        \end{tabularx}
